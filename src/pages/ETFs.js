...
import {
  TrendingUp, Tag, Leaf, Zap,
  Layers, Globe, Smartphone, Droplets,
  FolderOpen, CheckCircle, RefreshCw,
  Package, DollarSign, BarChart2,
  Compass, Landmark
} from 'lucide-react';
...
const benefits = [
  ...
  {
    icon: <Tag size={36} color="#c8973a" strokeWidth={1.5} />,
    title: 'Lower Taxes',
  ...
  {
    icon: <Leaf size={36} color="#c8973a" strokeWidth={1.5} />,
  ...
  {
    icon: <Zap size={36} color="#c8973a" strokeWidth={1.5} />,
...
const strategies = [
  {
    icon: <Layers size={64} color="#c8973a" strokeWidth={1} />,
    bg: '#fef3e8',
    title: 'Core ETFs',
  ...
  {
    icon: <Globe size={64} color="#c8973a" strokeWidth={1} />,
    bg: '#edf7f4',
    title: 'ESG ETFs',
  ...
  {
    icon: <Droplets size={64} color="#c8973a" strokeWidth={1} />,
    bg: '#fdf8ec',
...
const goalCards = [
  {
    icon: <Smartphone size={56} color="#c8973a" strokeWidth={1} />,
    title: 'Mutual Funds',
  ...
  {
    icon: <Droplets size={56} color="#c8973a" strokeWidth={1} />,
  ...
  {
    icon: <FolderOpen size={56} color="#c8973a" strokeWidth={1} />,
    ...
    return (
      <div style={{ textAlign: 'center' }}>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 16 }}>
          <CheckCircle size={48} color="#00b050" strokeWidth={1.5} />
        </div>
    ...
    <div style={{ fontFamily: 'DM Sans, sans-serif', color: '#0a1628', background: '#fff' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0a1628 0%, #1a2f5e 100%)', padding: '72px 40px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[
              { icon: <RefreshCw size={22} color="#c8973a" strokeWidth={1.5} />, label: 'Trades Like a Stock — Intraday Pricing' },
              { icon: <Package size={22} color="#c8973a" strokeWidth={1.5} />, label: 'Instant Diversification in One Fund' },
              { icon: <DollarSign size={22} color="#c8973a" strokeWidth={1.5} />, label: 'Low Expense Ratios' },
            ].map(item => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
            {strategies.map(s => (
              <div key={s.title} style={{ border: '1px solid #e8e2d9', overflow: 'hidden' }}>
                <div style={{ background: s.bg, padding: '48px 24px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  {s.icon}
                </div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'start' }}>
          <div>
            ...
            <p style={{ fontSize: 16, color: '#4a5568', lineHeight: 1.7, margin: '0 0 12px' }}>
              Every investor is unique. Use our questionnaire to find an asset mix that fits your investment goals and risk tolerance.
            </p>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 16, color: '#6b7280', maxWidth: 640, margin: '0 auto 36px' }}>
              ETFs and mutual funds are similar in many ways, but a few key differences set them apart.
            </p>
          </div>
      ...
      <section style={{ background: '#f8f5f0', padding: '80px 40px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
            {[
              { icon: <BarChart2 size={72} color="#c8973a" strokeWidth={1} />, bg: '#fdf8ec', title: 'Do it yourself', desc: 'Both industry experts and everyday people rely on our low-cost ETFs and mutual funds. Choose from diverse investments to save for your financial goals — on your own terms.', cta: 'Invest on your own', to: '/open-account' },
              { icon: <Compass size={72} color="#c8973a" strokeWidth={1} />, bg: '#edf7f4', title: 'Explore professional advice', desc: "Whatever you're working toward, we have a range of services to help you get there. Get a personalized plan and judgment-free guidance to keep you on track.", cta: 'Compare advice services', to: '/advice/wealth-planning' },
            ].map(item => (
              <div key={item.title} style={{ border: '1px solid #e8e2d9', overflow: 'hidden', background: '#fff' }}>
                <div style={{ background: item.bg, padding: '48px 24px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{item.icon}</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
            {goalCards.map(g => (
              <div key={g.title} style={{ border: '1px solid #e8e2d9', overflow: 'hidden' }}>
                <div style={{ background: '#f8f5f0', padding: '40px 24px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{g.icon}</div>
